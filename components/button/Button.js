...
function Button({ text, link = "", onClick }) {
  ...
  return (
    <Link href={link}>
      <button
        onClick={() => onClick()}
        className="inline-flex items-center text-white bg-neutral hover:bg-neutral-700 border-0 py-2 px-8 focus:outline-none rounded text-lg drop-shadow-md hover:drop-shadow-lg w-max"
